...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/assets/css/page5.css') }}" />
...
<body class="overflow-x-hidden">
    ...
    @include('frontend.components.global.finishing', [
        'finishing_bg' => 'frontend/assets/images/vanities/vaneties-footer.png',
    ...
    <script src="{{ asset('frontend/assets/js/tab-cabinet.js') }}"></script>
</body>
