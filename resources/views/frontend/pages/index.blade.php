...
@section('content')
    <main class="flex max-[768px]:flex-col">
        <!-- red section  -->
        <section style="background-image: url('{{ asset('assets/images/home/home-red.png') }}')"
            ...
            <div class="pl-[30px] pr-[30px] xl:pl-[170px] text-[#fff]">
                <a href="https://reywoodworking.com"><img class="w-[126px] xl:w-[250px]"
                        src="{{ asset('assets/images/home/rey-small-logo.png') }}" alt="small logo" /></a>
                <h2
                ...
                <a href="https://reywoodworking.com"><img class="w-[97px] xl:w-[240px]"
                        src="{{ asset('assets/images/home/red-button.png') }}" alt="red button" /></a>
            </div>
        </section>
        <!-- green section  -->
        <section style="background-image: url('{{ asset('assets/images/home/home-green.png') }}')"
            class="w-full  bg-no-repeat bg-cover pt-[100px] xl:pt-[450px] pb-[40px] xl:pb-[514px]">
            <div class="pl-[30px] pr-[30px] xl:pl-[170px] text-[#fff]">
                <a href="{{ url('/home') }}"><img class="w-[230px] xl:w-[460px]"
                        src="{{ asset('assets/images/home/Rey-Xpress-White-Logo.svg') }}" alt="small logo" /></a>
                <h2
                    class="uppercase font-[400] mt-[24px] xl:mt-[70px] mb-[15px] xl:mb-[40px] text-[30px] leading-[32px] xl:text-[74px] xl:leading-[80px]">
                    FOR TRADE <br>
                    PROFESSIONALs
                ...
                <a href="{{ url('/home') }}"><img class="w-[97px] xl:w-[240px]"
                        src="{{ asset('assets/images/home/green button.png') }}" alt="green button" /></a>
            </div>
        </section>
    </main>
