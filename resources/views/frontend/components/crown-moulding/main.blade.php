  ...
  <main class="max-w-[1920px] mx-auto px-[30px] xl:px-[150px]">
                      ...
                      <div class="productGallery">
                          ...
                          <li class="list-none">
                              ...
                              <label class="checkbox_label" for="radio1image1">
                                  <img class="w-full object-cover"
                                      src="{{ asset('assets/images/crown/product/74A.png') }}" alt="door" />
                              </label>
                              <h3
                          ...
                          <li class="list-none">
                              ...
                              <label class="checkbox_label" for="radio1image2">
                                  <img class="w-full object-cover"
                                      src="{{ asset('assets/images/crown/product/159A.png') }}" alt="door" />
                              </label>
                              <h3
                                  class="uppercase text-[8px] leading-[13px] md:text-[21px] md:leading-[36px] mt-[10px] md:mt-[20px]">
                                  159A
                          ...
                          <li class="list-none">
                              ...
                              <label class="checkbox_label" for="radio1image3">
                                  <img class="w-full object-cover"
                                      src="{{ asset('assets/images/crown/product/855A.png') }}" alt="door" />
                              </label>
                              <h3
                                  class="uppercase text-[8px] leading-[13px] md:text-[21px] md:leading-[36px] mt-[10px] md:mt-[20px]">
                                  855A
                          ...
                          <li class="list-none">
                              ...
                              <label class="checkbox_label" for="radio1image4">
                                  <img class="w-full object-cover"
                                      src="{{ asset('assets/images/crown/product/1031A.png') }}" alt="door" />
                              </label>
                              <h3
                                  class="uppercase text-[8px] leading-[13px] md:text-[21px] md:leading-[36px] mt-[10px] md:mt-[20px]">
                                  1031A
                          ...
                          <li class="list-none">
                              ...
                              <label class="checkbox_label" for="radio1image5">
                                  <img class="w-full object-cover"
                                      src="{{ asset('assets/images/crown/product/M450.png') }}" alt="door" />
                              </label>
                              <h3
                                  class="uppercase text-[8px] leading-[13px] md:text-[21px] md:leading-[36px] mt-[10px] md:mt-[20px]">
                                  M450
                          ...
                          <li class="list-none">
                              ...
                              <label class="checkbox_label" for="radio1image6">
                                  <img class="w-full object-cover"
                                      src="{{ asset('assets/images/crown/product/M525.png') }}" alt="door" />
                              </label>
                              <h3
                                  class="uppercase text-[8px] leading-[13px] md:text-[21px] md:leading-[36px] mt-[10px] md:mt-[20px]">
                                  M525
                          ...
                          <li class="list-none">
                              ...
                              <label class="checkbox_label" for="radio1image7">
                                  <img class="w-full object-cover"
                                      src="{{ asset('assets/images/crown/product/M550.png') }}" alt="door" />
                              </label>
                              <h3
                                  class="uppercase text-[8px] leading-[13px] md:text-[21px] md:leading-[36px] mt-[10px] md:mt-[20px]">
                                  M550
                          ...
                          <li class="list-none">
                              ...
                              <label class="checkbox_label" for="radio1image8">
                                  <img class="w-full object-cover"
                                      src="{{ asset('assets/images/crown/product/M625.png') }}" alt="door" />
                              </label>
                              <h3
                                  class="uppercase text-[8px] leading-[13px] md:text-[21px] md:leading-[36px] mt-[10px] md:mt-[20px]">
                                  M625
      ...
      <section>
          ...
          <section class="dimension_section">
              <!-- section 1 start  -->
              <div><img src="{{ asset('assets/images/drawers/drawers-dimention.png') }}" alt="dimension">
              </div>
              <!-- section 1 end -->
                  ...
                  <div class="w-full">
                      ...
                      <div class="flex justify-center items-center">
                          <div class="imageHoverContainer">
                              <img src="{{ asset('assets/images/crown/crown-moulding-cart.png') }}"
                                  alt="add to cart">
                          </div>
                      </div>
