          ...
          <section class="mt-[12px] lg:mt-[47px] bg-[#f5f4f3] p-[30px] lg:p-[70px] relative">
              ...
              <section class="flex justify-between max-md:flex-col max-md:gap-[12px] pb-[150px]">
                  ...
                  <div class="max-w-[600px] w-full md:px-[25px]">
                      <button
                          class="duration-300 border-[2px] border-[#c96d3e] hover:border-black hover:bg-black hover:text-white text-[#c96d3e] max-w-[560px] w-full bg-[#fff] uppercase text-[222] py-[8px] lg:py-[22px] text-[9px] leading-[15px] lg:text-[24px] lg:leading-[41px]">RESET
