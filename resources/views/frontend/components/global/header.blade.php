        ...
        <section class="mx-auto max-w-[1920px] px-[100px] flex justify-between gap-[20px] max-[1000px]:flex-col">
            ...
            <div class="logo">
                <a href="{{ url('/') }}"><img class="md:w-[440px] w-[165px]"
                        src="{{ asset('assets/images/navbar/Rey-Xpress-Color-Logo.svg') }}" alt="logo" /></a>
            </div>
                    ...
                    <div
                        ...
                        <a class="flex items-center gap-[10px]  max-[1000px]:py-[20px]"
                            ...
                            <img class="sm:w-[23px] w-[20px]"
                                src="{{ asset('assets/images/navbar/Rey-Xpress-Account-Icon.svg') }}" alt="account" />
                        ...
                        <a class="flex items-center gap-[10px] mx-[32px] px-[32px] border-l-2 border-r-2 border-[#9a999a]"
                            ...
                            <img class="sm:w-[28px] w-[20px]"
                                src="{{ asset('assets/images/navbar/Rey-Xpress-Projects-Icon.svg') }}" alt="project" />
                            PROJECTS
                        </a>
                        ...
                        <a class="flex items-center gap-[10px]" href="#">
                            <img class="sm:w-[24px] w-[20px]"
                                src="{{ asset('assets/images/navbar/Rey-Xpress-Shopping-Cart-Icon.svg') }}"
                                alt="cart" />
                            SHOPPING CART
                        </a>
            ...
            <section class="flex justify-between items-center ">
                <div>
                    <a href="#"><img id="nav_logo_white" class="w-[165px] active"
                            src="{{ asset('assets/images/navbar/Rey-Xpress-White-Logo.svg') }}" alt="logo" />
            ...
            <main" id="main_nav_container">
                ...
                <section class="uppercase mt-[40px] pb-[35px] border-b-[1px] border-[#fff]">
                    <a href="{{ url('/create-account') }}" class="flex gap-[6px] mb-[14px]">
                        <img class="w-[17px]"
                            src="{{ asset('assets/images/navbar/mobile/Rey-Xpress-Account-Icon.svg') }}"
                            alt="account" />
                        <h3>SIGN IN / CREATE ACCOUNT</h3>
                    </a>
                    <a href="{{ url('projects') }}" class="flex gap-[6px] mb-[14px]">
                        <img class="w-[20px]"
                            src="{{ asset('assets/images/navbar/mobile/Rey-Xpress-Projects-Icon.svg') }}"
                            alt="project" />
                        <h3>PROJECTS</h3>
                    </a>
                    <a href="#" class="flex gap-[6px] mb-[14px]">
                        <img class="w-[18px]"
                            src="{{ asset('assets/images/navbar/mobile/Rey-Xpress-Shopping-Cart-Icon.svg') }}"
                            alt="add to cart" />
                        <h3>SHOPPING CART</h3>
                    </a>
                </section>
