    ...
    <section style="background-image:url('{{ asset($finishing_bg) }}')"
        class=" bg-no-repeat bg-cover bg-center pt-[50px] pb-[50px] md:pt-[121px] md:pb-[140px] bg-[#343334] max-sm:h-[175px] xl:h-[450px]">
        <div class="ml-auto text-end text-white max-w-[1920px] mx-auto px-[35px] md:px-[150px]">
            <button
