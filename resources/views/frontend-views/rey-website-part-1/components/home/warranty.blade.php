...
<section style=" background-image: url('{{ asset('front-end/assets/images/homeHero/25year-background.jpg') }}') "
    ...
    <div
        ...
        <section class="flex justify-center max-[1200px]:hidden text-[#ffffff]">
            <div><img src="{{ asset('front-end/assets/images/homeHero/25desktop.png') }} " alt="25year"></div>
            ...
            <div class="ml-[-2px] pr-[145px] flex justify-center max-w-[847px] w-full flex-col bg-[#808041]">
                ...
                <p class="copy1">We use sustainable practices and PEFC certified materials to make our cabinets good for
                    you and the world. And we stand behind them with a 25-year warranty.</p>
            </div>
        </section>
        ...
        <section class="min-[1200px]:hidden text-[#ffffff]">
            <div><img src="{{ asset('front-end/assets/images/homeHero/25mobile.png') }} " alt="25year"></div>
            ...
            <div class="mt-[-2px] px-[45px] pb-[55px] flex justify-center max-w-[328px] w-full flex-col bg-[#808041]">
                ...
                <p class="copymobile1">We use sustainable practices and PEFC certified materials to make our cabinets
