  ...
  <main class="max-w-[1920px] mx-auto px-[30px] xl:px-[150px]">
    ...
    <!-- section 1 start  ======================================================================-->
    <section>
        <div class="bg-[#ecebe9] flex items-center justify-between py-[10px] px-[20px] md:py-[35px] md:px-[46px] mt-[58px] md:mt-[135px]">
          <div class="flex items-center gap-[10px] md:gap-[37px]">

            <h2 class="bg-white md:text-[50px] md:leading-[41px] text-[15px] leading-[12px] md:w-[95px] md:h-[95px] w-[28px] h-[28px] rounded-full flex justify-center items-center">1</h2>
    ...
    <section>
      <div class="bg-[#ecebe9] flex items-center justify-between py-[10px] px-[20px] md:py-[35px] md:px-[46px] mt-[58px] md:mt-[135px]">
        <div class="flex items-center gap-[10px] md:gap-[37px]">
          ...
          <h2 class="bg-white md:text-[50px] md:leading-[41px] text-[15px] leading-[12px] md:w-[95px] md:h-[95px] w-[28px] h-[28px] rounded-full flex justify-center items-center">2</h2>
          <h2 class="font-[700] text-[16px] leading-[13px] md:text-[42px] md:leading-[41px]">
            Select a Door Front Color
          </h2>
        </div>
        <div>
          <img class="w-[13px] h-[13px] md:w-[50px] md:h-[50px]" src="{{ asset('front-end/assets/images/doors/plus.png') }}" alt="plus icon"/>
    ...
    <section>
      <div class="bg-[#ecebe9] flex items-center justify-between py-[10px] px-[20px] md:py-[35px] md:px-[46px] mt-[58px] md:mt-[135px]">
        <div class="flex items-center gap-[10px] md:gap-[37px]">
          ...
          <h2 class="bg-white md:text-[50px] md:leading-[41px] text-[15px] leading-[12px] md:w-[95px] md:h-[95px] w-[28px] h-[28px] rounded-full flex justify-center items-center">3</h2>
          <h2 class="font-[700] text-[16px] leading-[13px] md:text-[42px] md:leading-[41px]">
            Dimensions
          </h2>
        </div>
...
<!-- section 1 start  -->
        <div><img src="{{ asset('front-end/assets/images/doors/dimension.png') }}" alt="dimension"></div>
<!-- section 1 end -->
...
<div class="flex justify-center  flex-wrap md:justify-between gap-[15px] mt-[24px] md:mt-[56px]">
  <div class="flex items-center gap-[9px] md:gap-[21px]">
    <label for="width" class="text-[16px] leading-[22px]
    md:text-[32px] md:leading-[52px] uppercase font-[700]">W</label>

    <select class="select_box_container" name="widthSelect" id="width">
...
<!-- another  -->
  <div class="flex items-center gap-[9px] md:gap-[21px]">
    ...
    md:text-[32px] md:leading-[52px] uppercase font-[700] pl-[5px]">H</h1>
...
<!-- section 2 end -->
    ...
    <!-- section 4 start  ======================================================================-->
    <section>
      <div class="bg-[#ecebe9] flex items-center justify-between py-[10px] px-[20px] sm:py-[35px] sm:px-[46px] mt-[58px] md:mt-[135px]">
      <div class="flex items-center gap-[10px] sm:gap-[37px]">
        <h2 class="bg-white sm:text-[50px] sm:leading-[41px] text-[15px] leading-[12px] sm:w-[95px] sm:h-[95px] w-[28px] h-[28px] rounded-full flex justify-center items-center" > 4 </h2>
      ...
      <div>
        <img class="w-[13px] h-[13px] sm:w-[50px] sm:h-[50px]"
          src="{{ asset('front-end/assets/images/doors/plus.png') }}" alt="plus icon"
        />
      </div>
    </div>
    ...
    <div class="flex justify-between gap-[13px] mt-[23px]">
      <li class="list-none">
        ...
        <label class="checkbox_label" for="image1">
          <img class="max-w-[790px] w-full" src="{{ asset('front-end/assets/images/doors/Rey-Xpress-Vertical Grain.jpg') }}" alt="one">
        </label>
        <h3 class="text-[12px] leading-[22px] md:text-[34px] md:leading-[60px] mt-[10px] lg:mt-[25px]">Vertical Grain</h3>
      </li>
      <!-- another  -->
      <li class="list-none">
        <input class="checkboxes" type="radio" name="radio7" id="image2">
        <label class="checkbox_label" for="image2">
          <img class="max-w-[790px] w-full" src="{{ asset('front-end/assets/images/doors/Rey-Xpress-Horizontal-Grain.jpg') }}" alt="two">
        </label>
        <h3 class="text-[12px] leading-[22px] md:text-[34px] md:leading-[60px] mt-[10px] lg:mt-[25px]">Horizontal Grain</h3>
      </li>
      <!-- another  -->
    ...
    <section>
      <div class="bg-[#ecebe9] flex items-center justify-between py-[10px] px-[20px] sm:py-[35px] sm:px-[46px] mt-[58px] md:mt-[135px]">
      <div class="flex items-center gap-[10px] sm:gap-[37px]">
        <h2 class="bg-white sm:text-[50px] sm:leading-[41px] text-[15px] leading-[12px] sm:w-[95px] sm:h-[95px] w-[28px] h-[28px] rounded-full flex justify-center items-center">
          5
        </h2>
        <h2 class="font-[700]  text-[16px] leading-[13px] sm:text-[42px] sm:leading-[41px]">
          Select Hinge Side
      ...
      <div>
        <img class="w-[13px] h-[13px] sm:w-[50px] sm:h-[50px]"
          src="{{ asset('front-end/assets/images/doors/plus.png') }}"
          alt="plus icon"
        />
      </div>
    </div>
    ...
    <div class="flex justify-between gap-[13px] mt-[23px]">
      <li class="list-none">
        ...
        <label class="checkbox_label" for="checkboxs1">
          <img class="max-w-[790px] w-full max-[500px]:h-[138px] object-cover" src="{{ asset('front-end/assets/images/doors/Rey-Xpress-Left-Hinge.svg') }}" alt="one">
        </label>
        <h3 class="text-[12px] leading-[22px] md:text-[34px] md:leading-[60px] mt-[10px] lg:mt-[25px]">Left Hinge</h3>
      </li>
      <!-- another  -->
      <li class="list-none">
        <input class="checkboxes" type="radio" name="radio9" id="checkboxs2">
        <label class="checkbox_label" for="checkboxs2">
          <img class="max-w-[790px] w-full max-[500px]:h-[138px] object-cover" src="{{ asset('front-end/assets/images/doors/Rey-Xpress-Right-Hinge.svg') }}" alt="two">
        </label>
        <h3 class="text-[12px] leading-[22px] md:text-[34px] md:leading-[60px] mt-[10px] lg:mt-[25px]">Right Hinge</h3>
      </li>
      <!-- another  -->
    </div>
    </section>
    ...
    <section class="mt-[24px] lg:mt-[86px]">
      ...
      <section class="mt-[12px] lg:mt-[47px] bg-[#f5f4f3] p-[30px] lg:p-[70px] relative">  
        <div class="flex xl:justify-between justify-center items-center xl:flex-row flex-col relative">
          <img class="md:hidden w-[18px] h-[18px] cursor-pointer absolute top-[24px] right-[18px]" src="{{ asset('front-end/assets/images/plus.png') }}" alt="plus">
          <div class="w-full">
            <p class="sm:hidden mt-[23px] ml-[18px] font-[700] text-[16px] leading-[24px] lg:text-[42px] lg:leading-[41px]">Total</p>
            
            <div class="flex justify-center items-center">
              <div class="imageHoverContainer">
               <img class="" src="{{ asset('front-end/assets/images/doors/slabDoors/door4.png') }}" alt="add to cart">
              </div>
            </div>
            <img class="max-lg:hidden w-[48px] h-[48px] mt-[60px] cursor-pointer" src="{{ asset('front-end/assets/images/plus.png') }}" alt="plus">

          </div>

          <div class="w-full xl:pl-[30px]">
            <p class="max-w-[560px] w-full mx-auto max-[640px]:hidden font-[700] text-[16px] leading-[24px] lg:text-[42px] lg:leading-[41px]">Total</p>
            <h2 class="relative text-center lg:mt-[145px] mb-[30px] lg:mb-[60px] text-[28px] leading-[28px] lg:text-[75px] lg:leading-[80px] max-lg:mt-[20px]">CAD $150.00 <sub class="absolute -ml-[30px] -mb-[10px] lg:-ml-[70px] lg:-mb-[20px] text-[13px] leading-[16px] lg:text-[28px] lg:leading-[28px]">each</sub></h2>
          ...
          <table class="table-auto">
            ...
            <tbody class="w-full text-[11px] leading-[14px] md:text-[28px] md:leading-[34px]">
              <tr class="flex mt-[8px] md:mt-[30px] md:flex-row flex-col">
                <td class="md:min-w-[380px] font-[700]">Cabinet Door Style:</td> <td>V-Groove Shaker</td>
              </tr>
              <!-- another -->
                <tr class="flex mt-[8px] md:mt-[30px] md:flex-row flex-col">
                  <td class="md:min-w-[380px] font-[700]">Door/Drawer Front Color: </td> <td>Dark Rockford Hickory</td>
                </tr>
              <!-- another -->
                <tr class="flex mt-[8px] md:mt-[30px] md:flex-row flex-col">
                  <td class="md:min-w-[380px] font-[700]">Dimensions: </td> <td>W 16 inch x H 30.5 inch</td>
                </tr>
              <!-- another -->
                <tr class="flex mt-[8px] md:mt-[30px] md:flex-row flex-col">
                  <td class="md:min-w-[380px] font-[700]">Grain Direction: </td> <td>Vertical</td>
                </tr>
              <!-- another -->
                <tr class="flex mt-[8px] md:mt-[30px] md:flex-row flex-col">
                  <td class="md:min-w-[380px] font-[700]">Hinges:</td> <td>Left Hinge</td>
                </tr>
              <!-- another -->
                <tr class="flex mt-[8px] md:mt-[30px] md:flex-row flex-col">
                  <td class="md:min-w-[380px] font-[700]">Delivery Time:</td> <td>Ships in 15 Business Days Or Less</td>
                </tr>
            </tbody>
          </table>
        ...
        <section class="flex justify-between max-md:flex-col max-md:gap-[12px] pb-[150px]">
          ...
          <div class="max-w-[600px] w-full md:px-[25px]">
            <button class="duration-300 border-[2px] border-[#c96d3e] hover:border-[#222] hover:bg-black hover:text-white max-w-[560px] w-full bg-[#fff] uppercase text-[#c96d3e] py-[8px] lg:py-[22px] text-[9px] leading-[15px] lg:text-[24px] lg:leading-[41px]">RESET ALL SELECTIONS</button>
