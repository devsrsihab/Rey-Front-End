  ...
  <main class="max-w-[1920px] mx-auto px-[30px] xl:px-[150px]">
    ...
    <!-- product showcase  -->
        <section>
            <section>
                <!-- Door image section  -->
                <section class="md:mt-[55px] mt-[30px] w-full">
                <!-- door start -->
                <div class="productGallery">
                    ...
                    <label class="checkbox_label" for="radio1image1">
                        ...
                        src="{{ asset('front-end/assets/images/crown/product/74A.png') }}"
                        alt="door"
                        />
                    </label>
                    <h3
                    ...
                    <label class="checkbox_label" for="radio1image2">
                        <img
                        class="w-full object-cover"
                        src="{{ asset('front-end/assets/images/crown/product/159A.png') }}"
                        alt="door"
                        />
                    </label>
                    <h3
                    ...
                    <label class="checkbox_label" for="radio1image3">
                        <img
                        class="w-full object-cover"
                        src="{{ asset('front-end/assets/images/crown/product/855A.png') }}"
                        alt="door"
                        />
                    </label>
                    <h3
                    ...
                    <label class="checkbox_label" for="radio1image4">
                        <img
                        class="w-full object-cover"
                        src="{{ asset('front-end/assets/images/crown/product/1031A.png') }}"
                        alt="door"
                        />
                    </label>
                    <h3
                    ...
                    <label class="checkbox_label" for="radio1image5">
                        <img
                        class="w-full object-cover"
                        src="{{ asset('front-end/assets/images/crown/product/M450.png') }}"
                        alt="door"
                        />
                    </label>
                    <h3
                    ...
                    <label class="checkbox_label" for="radio1image6">
                        <img
                        class="w-full object-cover"
                        src="{{ asset('front-end/assets/images/crown/product/M525.png') }}"
                        alt="door"
                        />
                    </label>
                    <h3
                    ...
                    <label class="checkbox_label" for="radio1image7">
                        <img
                        class="w-full object-cover"
                        src="{{ asset('front-end/assets/images/crown/product/M550.png') }}"
                        alt="door"
                        />
                    </label>
                    <h3
                    ...
                    <label class="checkbox_label" for="radio1image8">
                        <img
                        class="w-full object-cover"
                        src="{{ asset('front-end/assets/images/crown/product/M625.png') }}"
                        alt="door"
                        />
                    </label>
                    <h3
    ...
    <!-- section 1 start  -->
            <div><img src="{{ asset('front-end/assets/images/drawers/drawers-dimention.png') }}" alt="dimension"></div>
    <!-- section 1 end -->
          ...
          <div class="w-full">
            ...
            <div class="flex justify-center items-center">
              <div class="imageHoverContainer">
               <img src="{{ asset('front-end/assets/images/crown/crown-moulding-cart.png') }}" alt="add to cart">
              </div>
            </div>
          ...
          <table class="table-auto">
            ...
            <tbody class="w-full text-[11px] leading-[14px] md:text-[28px] md:leading-[34px]">
              <tr class="flex mt-[8px] md:mt-[30px] md:flex-row flex-col">
                <td class="md:min-w-[380px] font-[700]">Crown Moulding Color:</td> <td>74A</td>
              </tr>
              <!-- another -->
                <tr class="flex mt-[8px] md:mt-[30px] md:flex-row flex-col">
                  <td class="md:min-w-[380px] font-[700]">Crown Moulding Style:</td> <td>Dark Rockford Hickory</td>
                </tr>
              <!-- another -->
                <tr class="flex mt-[8px] md:mt-[30px] md:flex-row flex-col">
                  <td class="md:min-w-[380px] font-[700]">Dimensions:</td> <td>W 120 inch x H 6 inch</td>
                </tr>
              <!-- another -->
                <tr class="flex mt-[8px] md:mt-[30px] md:flex-row flex-col">
